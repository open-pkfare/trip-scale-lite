...
public class ActivitySearchService {
    ...
    private static final int MAX_ACTIVITIES_PER_CITY = 5;
    ...
    private List<ActivityInfo> searchActivitiesForCity(HotelInfo hotel, HotelLocationInfo location) {
        ...
        try {
            ...
            if (activities != null && activities.length > 0) {
                ...
                // 筛选评分最高的活动
                List<ActivityInfo> topActivities = filterTopActivities(filteredActivities);
     ...
     * @return 筛选后的活动列表
     */
    private List<ActivityInfo> filterTopActivities(List<ActivityInfo> activities) {
