...
public class PlanningPrompt {
    ...
    public static final String PLANNING_PROMPT = "###background\n"
        ...
        + "\n"
        + "### TODO\n"
        + "1. Extract relevant data from previous dialogs, don't miss every key factors."
        + "2. Do not add any additional factors which did not mentioned in previous dialogs."
        + "3. Fill location_code is the location has code."
        + "\n"
        + "### OUTPUT "
        + "output strictly follow the data constructure, 6 hyphens is mandatory:\n"
        + "\n"
        + "------[\n"
        + "\"stay_days\":int,\n"
