...
public class OptimizingPrompt {
  ...
  public static final String PROMPT = "### Background\n"
      ...
      + "hotels or activities for some day."
//      + "understand their specific demands, and convert them into structured information output.\n"
      ...
      + "\n"
      + "### Steps\n"
      + "First of all, confirm whether the user needs to adjust the current travel plan? Ask him which city's hotel or which day's activities he wants to adjust.\n"
